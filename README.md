...
A paper illustrating how a SAS programmer can employ PROC FCMP to define a custom function that converts partial date values into an ISO 8601 date format (required for submissions to the FDA). 
